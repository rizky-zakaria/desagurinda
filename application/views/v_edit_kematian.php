...
<div id="wrapper">
  ...
  <div id="content-wrapper">
    ...
    <h1 class="mt-4">Peristiwa Kematian</h1>
    <div class="card mb-3">
          <div class="card-header">
            <i class="fas fa-table pr-1 pb-0"></i>Edit Kematian
          </div>
          <div class="card-body">
            <form class="form-horizontal" action="<?php echo base_url('peristiwa/update_kematian') ?>" method="POST">

    <?php foreach($kematian as $k){ ?>

    <input type="hidden" name="kode_kematian" value="<?php echo $k->kode_kematian?>">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-4">
        <input type="text" name="nik" value="<?php echo $k->nik?>" placeholder="Nomor Induk Kependudukan" class="form-control" required >
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-4">
        <input type="text" name="no_kk" value="<?php echo $k->no_kk?>" placeholder="Nomor KK" class="form-control" required >
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-4">
        <input type="text" name="anak_ke" value="<?php echo $k->anak_ke?>" placeholder="Anak Ke" class="form-control" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-4">
        <input type="date"  value="<?php echo $k->tanggal_kematian?>" name="tanggal_kematian" placeholder="" class="form-control" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-4">
        <input type="time" name="jam_kematian"  value="<?php echo $k->jam_kematian?>" class="form-control" required>
      </div>
    </div>
  ...
  <div class="form-group row">
      ...
      <div class="col-sm-4">
        <input type="text" name="tempat_kematian" value="<?php echo $k->tempat_kematian?>" placeholder="Tempat Kematian" class="form-control" required>
      </div>
    </div>
