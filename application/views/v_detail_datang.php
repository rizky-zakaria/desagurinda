...
<div id="wrapper">
  ...
  <div id="content-wrapper">
    ...
    <h1 class="mt-4">Data Penduduk Datang</h1>
    <div class="card mb-3">
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tr>
                  ...
                  ?></td>
                  <td><?php echo $datang->no_kk ?></td>
                  <td><?php echo $p->alamat ?></td>
                  <td><?php
                  $nama_kk = $this->m_penduduk->tampil_kepala_keluarga_id($datang->no_kk)->row();
                  echo $nama_kk->nama;
                  ?></td>
                  ...
                  ?></td>
                  <td>
                      <a class=" btn btn-sm btn-success text-light mb-1" href="<?php  echo base_url('penduduk/edit/').$p->nik ?>">Edit</a>
